...
O projeto possui uma API desenvolvida em Node.js com typescript utilizando o express para fazer a gestão das rotas, o front-end foi desenvolvido em react utilizando o typescript, vite e tailwind
